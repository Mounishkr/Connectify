...
import 'timetable_copy_model.dart';
export 'timetable_copy_model.dart';

class TimetableCopyWidget extends StatefulWidget {
  const TimetableCopyWidget({super.key});

  @override
  _TimetableCopyWidgetState createState() => _TimetableCopyWidgetState();
}

class _TimetableCopyWidgetState extends State<TimetableCopyWidget>
    with TickerProviderStateMixin {
  late TimetableCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TimetableCopyModel());
