...
class _EditProfileWidgetState extends State<EditProfileWidget> {
  ...
  void initState() {
    ...
    _model.nameController ??=
        TextEditingController(text: widget.dogProfile?.personName);
    _model.nameFocusNode ??= FocusNode();

    _model.dogAgeController ??=
        TextEditingController(text: widget.dogProfile?.personAge);
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<DogsRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final editProfileDogsRecord = snapshot.data!;
        return Scaffold(
          key: scaffoldKey,
          backgroundColor: FlutterFlowTheme.of(context).secondaryBackground,
          appBar: AppBar(
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Expanded(
                              child: Text(
                                'Fill out your profiles below! And then get to sharing your thoughts...',
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  await widget.dogProfile!.reference
                                    ...
                                    personPhoto: _model.uploadedFileUrl,
                                    personName: _model.nameController.text,
                                    personAge: _model.dogAgeController.text,
                                  ));
                                  context.pop();
                                },
                                text: 'Save Changes',
